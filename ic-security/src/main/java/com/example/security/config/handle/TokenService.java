...
public class TokenService {
    ...
    public LoginUser getLoginUser(HttpServletRequest request) {
        ...
        if (StringUtils.isNotEmpty(token)) {
            ...
            // 解析对应的权限以及用户信息
            String uuid = (String) claims.get(GlobalConstant.LOGIN_USER_KEY);
    ...
    public String createToken(LoginUser loginUser) {
        ...
        claims.put(GlobalConstant.LOGIN_USER_KEY, token);
    ...
    private String getToken(HttpServletRequest request) {
        ...
        if (StringUtils.isNotEmpty(token) && token.startsWith(GlobalConstant.TOKEN_PREFIX)) {
    ...
    private String getTokenKey(String uuid) {
        return GlobalConstant.LOGIN_TOKEN_KEY + uuid;
    }
}
